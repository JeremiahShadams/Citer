...
export default function ArchitectureModeDemo() {
  ...
  return (
    <section id="architecture" className="py-24 bg-void border-t border-hairline">
      <div className="mx-auto max-w-5xl px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Visual Graph Layout */}
          <div className="lg:col-span-8 rounded-xl border border-hairline bg-surface-1 p-6 relative">
          ...
          <div className="lg:col-span-4 rounded-xl border border-hairline-bright bg-surface-2 p-6 shadow-xl sticky top-24">
