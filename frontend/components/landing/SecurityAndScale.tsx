...
export default function SecurityAndScale() {
  return (
    <section id="security" className="py-24 bg-void border-t border-hairline">
      <div className="mx-auto max-w-5xl px-4 space-y-20">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="rounded-xl border border-hairline bg-surface-1 p-5">
              ...
              <p className="text-xs text-zinc-300 font-sans leading-relaxed">
                Zero-data retention agreements ensure no source code is logged, retained, or utilized for foundational model retraining.
              </p>
            </div>
        ...
        <div className="rounded-xl border border-hairline bg-surface-1 p-8">
          ...
          <h3 className="text-2xl sm:text-3xl font-bold text-white mb-3">
            The code changes. The understanding updates.
          </h3>
          <p className="text-sm text-zinc-400 max-w-2xl mb-8 font-sans">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-2 font-mono text-center text-xs">
            ...
            <div className="rounded border border-hairline bg-surface-0 p-3">
              ...
              <div className="text-white font-semibold">Reparse AST</div>
            </div>
            <div className="rounded border border-hairline bg-surface-0 p-3">
              <div className="text-zinc-500 text-[10px] mb-1">05</div>
              <div className="text-zinc-200 font-semibold">Map Callers</div>
            </div>
            <div className="rounded border border-hairline bg-surface-0 p-3">
              <div className="text-zinc-500 text-[10px] mb-1">06</div>
              <div className="text-zinc-200 font-semibold">Re-embed</div>
            </div>
            <div className="rounded border border-hairline bg-surface-0 p-3">
