...
export default function AskTerminalDemo() {
  ...
  return (
    <section id="investigation" className="relative py-24 bg-void border-t border-hairline">
      <div className="mx-auto max-w-5xl px-4">
        ...
        <div className="rounded-xl border border-hairline bg-surface-1 shadow-2xl overflow-hidden">
          {/* Terminal Header */}
          <div className="flex items-center justify-between border-b border-hairline bg-surface-0 px-4 py-3">
